...
<body>
    ...
    <div class="center-message">
        <strong>20-10 Anh yêu em nhiều lắm</strong> <!--Sửa tiêu đề chúc mừng ở đây-->
        <span id="centerText">
            Ngày Phụ nữ vợ yêu của anh phải thật là hạnh phúc nhoaaa<br> <!-- Sử lời nhắn hiển thị đầu ở đây-->
            Vợ yêu của chồng mãi mãi xinh đẹp và luôn yêu anh nhoaaa
        </span>
    </div>
    ...
    <script>
        ...
        const messages = [
            {
                img: "file:///C:/Users/ADMIN/Downloads/z7134241804196_536350d66489b4d8057849bba9190f31.jpg", //Thay ảnh
